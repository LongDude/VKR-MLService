...
class TopicQuarterReportRepository(BaseRepository):
    ...
    def upsert_report(
        ...
        *,
        ...
        period_key: str,
        summary: str | None,
        period_characterization: str | None,
        ...
        values = {
            ...
            "summary": summary,
            "period_characterization": period_characterization,
            ...
            report_id = self.session.scalar(
                stmt.on_conflict_do_update(
                    ...
                    set_={
                        ...
                        "period_characterization": stmt.excluded.period_characterization,
    ...
    def to_dto(self, report: TopicQuarterReport) -> TopicQuarterReportDTO:
        ...
        return TopicQuarterReportDTO(
            ...
            period_characterization=report.period_characterization,
