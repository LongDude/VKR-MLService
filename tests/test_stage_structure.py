...
MODULES = [
    ...
    "repositories.graph",
    "repositories.topic_quarter_reports",
    "ml.facades.topic_quarter_reports",
    "ml.pipelines.topic_quarter_report_pipeline",
    "ml.services.quarter_periods",
    "ml.services.topic_quarter_report_prompts",
